...
/**
 * Generates primary key values for chaperone models based on application configuration.
 *
 * Supports multiple primary key strategies: auto-incrementing IDs, UUIDs, and ULIDs.
 * The type is determined by the chaperone.primary_key_type config value, allowing
 * consistent key generation across all chaperone records.
 *
 * ```php
