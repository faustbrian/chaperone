...
namespace Cline\Chaperone\Database\Concerns;

use Cline\Chaperone\Enums\PrimaryKeyType;
use Cline\Chaperone\Exceptions\InvalidPrimaryKeyValueException;
use Cline\Chaperone\Support\PrimaryKeyGenerator;
...
/**
 * Configures model primary keys based on Chaperone package configuration.
 *
 * This trait enables automatic primary key type detection and generation based
 * on the `chaperone.primary_key_type` configuration. It supports standard auto-incrementing
...
trait HasChaperonePrimaryKey
{
     ...
     *
     * Reads the chaperone.primary_key_type configuration to determine if the primary
    ...
    public function uniqueIds(): array
    {
        ...
        $configValue = Config::get('chaperone.primary_key_type', 'id');
     ...
     */
    protected static function bootHasChaperonePrimaryKey(): void
    {
